...
Two libraries dominate distributed job scheduling in Java: JobRunr and db-scheduler.
...
<figure>
<img src="/documentation/jobrunr-overview.webp" class="kg-image">
...
Start with worker count equal to your CPU cores. Adjust based on job characteristics.

- **CPU bound jobs:** Keep worker count at core count
- **I/O bound jobs:** Increase workers (2x to 4x core count)
- **Virtual threads:** Enable them and increase further
...
With virtual threads (Java 21+), you can go much higher:
...
2. [Configure your database](/en/documentation/installation/storage/)
